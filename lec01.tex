...
\begin{eg}[Convergent Case: Fixed Point Iteration on $x - \cos x = 0$]{cos-fixed-point}
  ...
  Both runs spiral into the fixed point $r \approx 0.739$; a tighter tolerance just adds more steps near $r$. The cobwebs (top row) show the geometric approach; the iterate-vs-index plots (bottom row) show the same convergence as damped oscillation.
